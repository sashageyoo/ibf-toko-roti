    ...
    const testUsers = [
      {
        ...
        email: "manager.inv@ibfbakery.com",
        role: "manager_inventaris" as const,
      },
      {
        username: "operator_gudang",
        name: "Operator Gudang",
        email: "operator.gudang@ibfbakery.com",
        role: "operator_gudang" as const,
      },
      {
        username: "manager_prod",
        name: "Manager Produksi",
        email: "manager.prod@ibfbakery.com",
        role: "manager_produksi" as const,
      },
      {
        username: "operator_prod",
        name: "Operator Produksi",
        email: "operator.prod@ibfbakery.com",
